const ChatWindow = ({ recipientUserId, setRecipientUserId, profilePicture, userName, profilePictureExist }) => {
          ...
          <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
            ...
            >
              <div className="h-20 w-20 rounded-full border overflow-hidden">
                <img
                  src={profilePictureExist ? profilePicture : "https://via.placeholder.com/80x80"}
                  alt="Avatar"
                  className="h-full w-full"
                />
              </div>
              <div className="text-sm font-semibold mt-2">{userName || "N/A"}</div>
